...
import FacebookIcon from '@mui/icons-material/Facebook'; // Import Facebook icon for the button
...
//             navigate("/");  // This redirects to the home page (index)
//           } else {
...
const handleGoogleSignIn = async () => {
    ...
    const handleFacebookSignIn = async () => {
        try {
            ...
            // Optionally save user data or perform additional actions
        } catch (error) {
